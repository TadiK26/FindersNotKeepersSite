    ...
    * Methods to generate various derivations of a "from" clause, including
    ...
    def join(
        ...
        E.g.::
            ...
            j = user_table.join(
                address_table, user_table.c.id == address_table.c.userID
            )
    ...
    def outerjoin(
        ...
        The above is equivalent to::
            ...
            j = user_table.join(
                address_table, user_table.c.id == address_table.c.userID, isouter=True
            )
...
class GenerativeSelect(DialectKWArgs, SelectBase, Generative):
    ...
    def slice(
        ...
        For example, ::
            ...
            stmt = select(userModel).order_by(userModel.id).slice(1, 3)
        ...
        *,
        ...
        E.g.::
            ...
            stmt = select(user_table, address_table).join_from(
                user_table, address_table, user_table.c.id == address_table.c.userID
            )
        ...
        .. sourcecode:: sql
            ...
            SELECT user.id, user.name, address.id, address.email, address.userID
