...
def text(text: str) -> TextClause:
    ...
    E.g.::
        ...
        t = text("SELECT * FROM users WHERE id=:userID")
        result = connection.execute(t, {"userID": 12})
    ...
    such as for the WHERE clause of a SELECT statement::
        ...
        s = select(users.c.id, users.c.name).where(text("id=:userID"))
        result = connection.execute(s, {"userID": 12})
