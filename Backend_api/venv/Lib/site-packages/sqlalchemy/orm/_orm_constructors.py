...
def with_loader_criteria(
    ...
    **globally**, meaning it will apply to the entity as it appears
    ...
    ``userModel.addresses`` collection is loaded, regardless of the kind
    of loading used::
    ...
    Above, the "selectinload" for ``userModel.addresses`` will apply the
    ...
    **kw: Any,
    ...
    :param uselist:
      ...
      with collections or scalar attributes::
          ...
          >>> userModel.addresses.property.uselist
          True
...
def join(
    ...
    :meth:`_sql.Select.select_from` method, as in::
        ...
        stmt = (
            select(userModel)
            .select_from(join(userModel, Address, userModel.addresses))
