...
export default function CreateListing() {
  ...
  const [form, setForm] = useState({
    ...
    categoryId: "",      // will hold the numeric id (1..8)
    description: "",
    contactName: "",
    contactEmail: "",
    contactPhone: "",
  ...
  const onSubmit = (e) => {
    ...
    /* NEW: keep a readable label if you want it for UI (optional) */
    const categoryLabel =
      CATEGORIES.find(c => c.id === form.categoryId)?.label || "";

    const newItem = {
      id: Date.now(), // simple demo id
      ...form,                 // includes numeric categoryId
      categoryLabel,           // optional helper for display
      img: photoDataUrl || "", // store data URL for demo
    };
